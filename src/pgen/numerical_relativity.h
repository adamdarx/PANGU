...
void NumericalRelativityMinkowski(parthenon::MeshBlock *block,
                                  parthenon::ParameterInput *pin);
void SyncGRHDProblem(parthenon::MeshBlock *block,
                     parthenon::ParameterInput *pin);
void SyncGRMHDProblem(parthenon::MeshBlock *block,
                      parthenon::ParameterInput *pin);
...
void NumericalRelativitySchwarzschild(parthenon::MeshBlock *block,
                                      parthenon::ParameterInput *pin);
...
void NumericalRelativityBoostedPuncture(parthenon::MeshBlock *block,
                                        parthenon::ParameterInput *pin);
void NumericalRelativityPuncture(parthenon::MeshBlock *block,
                                 parthenon::ParameterInput *pin);
void SyncGRMHDBoostedPuncture(parthenon::MeshBlock *block,
                              parthenon::ParameterInput *pin);
void NumericalRelativityLinearWave(parthenon::MeshBlock *block,
                                   parthenon::ParameterInput *pin);
void NumericalRelativityGaugeWave(parthenon::MeshBlock *block,
                                  parthenon::ParameterInput *pin);
...
void RegisterNumericalRelativityExtrapolationBoundaries(
    parthenon::ApplicationInput *app_input);
void RegisterNumericalRelativityOutflowBoundaries(
    parthenon::ApplicationInput *app_input);
void NumericalRelativityAfterLoop(parthenon::Mesh *mesh,
                                  parthenon::ParameterInput *pin,
                                  parthenon::SimTime &time);
void NumericalRelativityLinearWaveAfterLoop(parthenon::Mesh *mesh,
                                            parthenon::ParameterInput *pin,
                                            parthenon::SimTime &time);
void NumericalRelativityGaugeWaveAfterLoop(parthenon::Mesh *mesh,
                                           parthenon::ParameterInput *pin,
                                           parthenon::SimTime &time);
